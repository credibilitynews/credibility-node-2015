...
module.exports = [
  {
    route:
      "topicsById[{integers:topicIds}]['id','title','hashtag','created_at','views','user_id']",
      ...
      return topicService
        ...
        .catch(function (why) {
          process.stdout.write(
            "catch#topicsById.links.length" + why + why.stack
          );
        });
    },
  },
  {
    route:
      "latestTopics[{integers:n}]['id','title','hashtag','created_at','views','user_id']",
    get: function (pathSet) {
